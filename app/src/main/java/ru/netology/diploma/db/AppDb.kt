...
@Database(entities = [PostEntity::class, EventEntity::class, UserEntity::class, WallEntity::class, JobEntity::class, PostRemoteKeyEntity :: class, EventRemoteKeyEntity :: class], version = 1)
