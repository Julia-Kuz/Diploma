...
class SignUpViewModel @Inject constructor (private val appAuth: AppAuth): ViewModel() {
    ...
    fun setPhoto(uri: Uri, file: File, type: AttachmentType) {    //это первая часть сохранения, 2 часть - в функции registerWithAvatarAndSetAuth (читаем инфо из значения photo)
